  ...
  return (
    ...
    return (
        ...
        <View style={styles.header}>
            <Text style={styles.text_header}>اضافة محضر انتخابات الجهة - لائحة المرأة  -</Text>
        </View>
...
export default connect (mapStateToProps, mapDispatchProps)(ElectionRF);
